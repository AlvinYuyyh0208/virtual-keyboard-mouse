...
while True:
    ...
    if ballPos[0] < 30 or ballPos[0] > 1220:
        gameOver = True
        img = imOver
        cv2.putText(img, str(score[0]).zfill(2), (110, 275), cv2.FONT_HERSHEY_PLAIN, 3, (171, 137, 27), 5)
        cv2.putText(img, str(score[1]).zfill(2), (460, 275), cv2.FONT_HERSHEY_PLAIN, 3, (73, 73, 204), 5)
    ...
    # if the game not over
        ...
        cv2.putText(img, str(score[0]), (300, 650), cv2.FONT_HERSHEY_PLAIN, 5, (171, 137, 27), 5)
        cv2.putText(img, str(score[1]), (900, 650), cv2.FONT_HERSHEY_PLAIN, 5, (73, 73, 204), 5)
